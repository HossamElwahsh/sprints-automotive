    ...
    switch (enu_dio_port) {
        ...
        case DIO_PORT_A:
            if (enu_dio_direction == DIO_OUT) {
                ...
                CLEAR_BIT(DIO_U8_DDR_A_REG, enu_dio_pin); // set pin as input
            } else {
                // error handling
        ...
        case DIO_PORT_B:
            if (enu_dio_direction == DIO_OUT) {
                ...
                CLEAR_BIT(DIO_U8_DDR_B_REG, enu_dio_pin); // set pin as input
            } else {
                // error handling
                return DIO_WRONG_PIN_VAL;
            }
        ...
        case DIO_PORT_C:
            if (enu_dio_direction == DIO_OUT) {
                ...
                CLEAR_BIT(DIO_U8_DDR_C_REG, enu_dio_pin); // set pin as input
            } else {
                // error handling
                return DIO_WRONG_PIN_VAL;
            }
        ...
        case DIO_PORT_D:
            if (enu_dio_direction == DIO_OUT) {
                ...
                CLEAR_BIT(DIO_U8_DDR_D_REG, enu_dio_pin); // set pin as input
            } else {
                // error handling
                return DIO_WRONG_PIN_VAL;
            }
 ...
 *         (DIO_OK if the operation succeeded, DIO_ERROR otherwise)
 */
enu_dio_error_t_ DIO_portInit(enu_dio_port_t_ enu_dio_port, enu_dio_port_direction_t_ en_a_portDir, uint8_t_ u8_a_mask) {
 ...
 *         (DIO_OK if the operation succeeded, DIO_ERROR otherwise)
 */
enu_dio_error_t_ DIO_portWrite(enu_dio_port_t_ enu_dio_port, enu_dio_port_val_t_ enu_dio_port_val, uint8_t_ u8_a_mask)
{
    if(u8_a_mask == DIO_MASK_ZERO) u8_a_mask = DIO_NO_MASK;
 ...
 *         (DIO_OK if the operation succeeded, DIO_ERROR otherwise)
 */
enu_dio_error_t_ DIO_portToggle(enu_dio_port_t_ enu_dio_port, uint8_t_ u8_a_mask)
{
    if(u8_a_mask == DIO_MASK_ZERO) u8_a_mask = DIO_NO_MASK;
    switch (enu_dio_port) {
        case DIO_PORT_A:
